...
รุ่นที่ใช้งานปัจจุบัน: **Hermes SnD v1.8.6 / Apps Script deployment version 13**
...
- เมื่อยังไม่ได้ตั้ง `ENDPOINT_URL` ระบบจะวิเคราะห์ต่อในโหมด Analysis-only, แสดงเหตุผลครบ และไม่สร้างคำสั่งซื้อ
